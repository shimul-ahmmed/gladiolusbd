    ...
    function parseFormDetails()
    {
        ...
        foreach (array_filter($_POST['ninja_ajax_form']['form']) as $key => $value)
        {
            $form[sanitize_text_field($value)]= array(
                'emailkey'=> $this->getFieldId(sanitize_text_field($_POST['ninja_ajax_form']['emailkey'][$key])),
                'phonekey'=> $this->getFieldId(sanitize_text_field($_POST['ninja_ajax_form']['phonekey'][$key])),
                'verifyKey'=> $this->getFieldId(sanitize_text_field($_POST['ninja_ajax_form']['verifyKey'][$key])),
