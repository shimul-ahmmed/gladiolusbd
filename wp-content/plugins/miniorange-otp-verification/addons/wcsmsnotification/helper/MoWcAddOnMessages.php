...
final class MoWcAddOnMessages extends BaseMessages
{
	...
	private function __construct()
	{
		...
		define("MO_WC_ADDON_MESSAGES", serialize( array(
			...
			self::ORDER_COMPLETED_SMS 			    => mo_(  "Hello {username}, Your order number {order-number} with {site-name} ordered on {order-date} has been proccessed. It will be delivered shortly."),
