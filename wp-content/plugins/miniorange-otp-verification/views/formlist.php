...
echo'							    
                    ...
                    echo   '<b><font color="#0085ba"><a style = "text-decoration: none;" href="'.esc_url($url).'" data-form="YourOwnForm#YourOwnForm">Not able to find your form.</a></font></b>';mo_draw_tooltip(
