...
echo'	<div class="mo_otp_form" id="'.get_mo_class($handler).'"><input type="checkbox" '.esc_attr($disabled).' id="ninja_form" class="app_enable" data-toggle="ninja_ajax_form_options" name="mo_customer_validation_nja_enable" value="1"
										'.esc_attr($ninja_ajax_form_enabled).' /><strong>'. esc_attr($form_name) .'</strong>';
...
echo'							<div class="mo_registration_help_desc" '.esc_attr($ninja_ajax_form_hidden).' id="ninja_ajax_form_options">
									...
									<div '.(esc_attr($ninja_ajax_form_enabled_type) != esc_attr($ninja_ajax_form_type_email) ? "hidden" :"").' class="mo_registration_help_desc" id="nfae_instructions" >
											...
											<ol>
												<li><a href="'.esc_url($ninja_ajax_form_list).'" target="_blank">'. mo_( "Click Here" ).'</a> '. mo_( " to see your list of forms" ).'</li>
												...
												<li>'. mo_( "Enter your Form ID, the Email Field Key and the Verification Field Key below" ).':<br>
													<br/>'. mo_( "Add Form " ).': <input type="button"  value="+" '. esc_attr($disabled) .' onclick="add_ninja_ajax(\'email\',1);" class="button button-primary" />&nbsp;
									...
									<div '.(esc_attr($ninja_ajax_form_enabled_type) != esc_attr($ninja_ajax_form_type_phone) ? "hidden" : "").' class="mo_registration_help_desc" id="nfap_instructions" >
											...
											<ol>
												...
												<li>'. mo_( "Enter your Form ID, the Phone Field Key and the Verification Field Key below" ).':<br>
													<br/>'. mo_( "Add Form " ).': <input type="button"  value="+" '. esc_attr($disabled) .' onclick="add_ninja_ajax(\'phone\',2);" class="button button-primary" />&nbsp;
