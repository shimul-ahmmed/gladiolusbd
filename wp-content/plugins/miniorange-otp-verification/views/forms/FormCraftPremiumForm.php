...
echo'	<div class="mo_otp_form" id="'.get_mo_class($handler).'"><input type="checkbox" '.esc_attr($disabled).' id="formcraft_premium" class="app_enable" data-toggle="fcpremium_options" name="mo_customer_validation_fcpremium_enable" value="1"
										'.esc_attr($fcpremium_enabled).' /><strong>'.esc_attr($form_name).'</strong>';
...
echo'							<div class="mo_registration_help_desc" '.esc_attr($fcpremium_hidden).' id="fcpremium_options">
									...
									<div '.(esc_attr($fcpremium_enabled_type) != esc_attr($fcpremium_type_email) ? "hidden" :"").' class="mo_registration_help_desc" id="fcpe_instructions" >
											...
											<ol>
												<li><a href="'.esc_url($fcpremium_list).'" target="_blank">'. mo_( "Click Here" ).'</a> '. mo_( " to see your list of forms" ).'</li>
												...
												<li>'. mo_( "Enter your Form ID, the label of the Email Field and Verification Field below" ).':<br>
													<br/>'. mo_( "Add Form " ).': <input type="button"  value="+" '. esc_attr($disabled) .' onclick="add_fcpremium(\'email\',1);" class="button button-primary" />&nbsp;
...
echo'											</li>
									...
									<div '.(esc_attr($fcpremium_enabled_type) != esc_attr($fcpremium_type_phone) ? "hidden" : "").' class="mo_registration_help_desc" id="fcpp_instructions" >
											...
											<ol>
												...
												<li>'. mo_( "Add an Verification Field to your form where users will enter the OTP received. Note the Label of the verification field." ).'</li>
												<li>'. mo_( "Enter your Form ID, the label of the Email Field and Verification Field below" ).':<br>
													<br/>'. mo_( "Add Form " ).': <input type="button"  value="+" '. esc_attr($disabled) .' onclick="add_fcpremium(\'phone\',2);" class="button button-primary" />&nbsp;
