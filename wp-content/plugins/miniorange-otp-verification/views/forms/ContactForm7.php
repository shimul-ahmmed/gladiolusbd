...
echo'		<div class="mo_otp_form" id="'.get_mo_class($handler).'">
		        <input  type="checkbox" '.esc_attr($disabled).' 
                        ...
                        value="1" '.esc_attr($cf7_enabled).' /><strong>'. esc_attr($form_name) . '</strong>';
...
echo'			<div class="mo_registration_help_desc" '.esc_attr($cf7_hidden).' id="cf7_contact_options">
                    ...
                    <div '.(esc_attr($cf7_enabled_type) != esc_attr($cf7_type_email) ? "hidden" :"").' class="mo_registration_help_desc" 
                            ...
                            <ol>
                                ...
                                <li><a href="'.esc_url($cf7_field_list).'" target="_blank">'. mo_( "Click Here").'</a>'
                                ...
                                <li>'. mo_( "Enter the name of the email field below").': <input class="mo_registration_table_textbox" id="mo_customer_validation_cf7_email_field_key" name="mo_customer_validation_cf7_email_field_key" type="text" value="'.esc_attr($cf7_field_key).'">
                    ...
                    <p><input type="radio" '.esc_attr($disabled).' id="cf7_contact_phone" class="app_enable" data-toggle="cf7_contact_phone_instructions" name="mo_customer_validation_cf7_contact_type" value="'.$cf7_type_phone.'"
                        '.( esc_attr($cf7_enabled_type) == esc_attr($cf7_type_phone) ? "checked" : "").' /><strong>'.mo_( "Enable Phone verification").'</strong>
                    </p>
                    <div '.(esc_attr($cf7_enabled_type) != esc_attr($cf7_type_phone) ? "hidden" : "").' class="mo_registration_help_desc" id="cf7_contact_phone_instructions" >
                            ...
                            <ol>
                                ...
                                <li><a href="'.esc_url($cf7_field_list).'" target="_blank">'.mo_( "Click Here").'</a> '.mo_(" to see your list of Contact Forms.").'</li>
                                <li>'.mo_( "Click on the <b>Edit</b> option of your form.").'</li>
                                <li>
