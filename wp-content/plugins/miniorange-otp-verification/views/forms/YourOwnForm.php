...
echo'		<div class="mo_otp_form" id="'.esc_attr(get_mo_class($handler)).'">
		        ...
		        <input  type="checkbox" '.esc_attr($disabled).' 
                        ...
                        value="1" '.esc_attr($custom_form_enabled).' /><strong>'. $form_name . '</strong>';
...
echo'			<div class="mo_registration_help_desc" '.esc_attr($custom_form_hidden).' id="custom_form_contact_options">
            ...
            <span ><b>NOTE: Choosing your selector</b><br><li> Element\'s id selector looks like \'#element_id\'</li><li> Element\'s class selector looks like \'.element_class\' </li><li> Element\'s name selector is \'input[name=\'element_name\']\' </li> 
                    ...
                    <input type="hidden" name="custom_form[form][]" value="1"/>
                                    <input type="text" id = "mo_customer_validation_custom_form_submit_id" name="custom_form[email][submit_id]" style="width:30%" placeholder = "Enter your form\'s Submit button selector" value="'.esc_attr(mo_($custom_form_submit_selector)).'"/>
                                </li>
                ...
                <span class="tooltiptext" style="background-color:lightgrey;color:#606060">
                    ...
                    <span class="body">You need to provide the unique selector of the field you want to verify. You can find the selector while adding the desired field in your form or by using your browsers inspector.  
                                   ...
                                   <input type="text" name="custom_form[email][field_id]" style="width:30%;" placeholder = "Enter your form\'s Email Field selector"value="'.esc_attr(mo_($custom_form_field_selector)).'"/>
                                </li>
                    ...
                    <p><input type="radio" '.esc_attr($disabled).' id="custom_form_contact_phone" class="app_enable" data-toggle="custom_form_contact_phone_instructions" name="mo_customer_validation_custom_form_enable_type" value="'.esc_attr($custom_form_type_phone).'"
                        '.( esc_attr($custom_form_enabled_type) == esc_attr($custom_form_type_phone) ? "checked" : "").' /><strong>'.mo_( "Enable Phone verification").'</strong>
                    </p>
                    <div '.(esc_attr($custom_form_enabled_type) != esc_attr($custom_form_type_phone) ? "hidden" : "").' class="mo_registration_help_desc" id="custom_form_contact_phone_instructions" >
            ...
            <input type="hidden" name="custom_form[form][]" value="1"/>
                                    <input type="text" id = "mo_customer_validation_custom_form_submit_id" name="custom_form[phone][submit_id]" style="width:30%" placeholder = "Enter your form\'s Submit button selector" value="'.esc_attr(mo_($custom_form_submit_selector)).'"/>
                                </li>
                ...
                <span class="tooltiptext" style="background-color:lightgrey;color:#606060">
                    ...
                    <span class="body">You need to provide the unique selector of the field you want to verify. You can find the selector while adding the desired field in your form or by using your browsers inspector.
                                   ...
                                   <input type="text" name="custom_form[phone][field_id]" style="width:30%;" placeholder = "Enter your form\'s Phone Field selector"value="'.esc_attr(mo_($custom_form_field_selector)).'"/>
                                </li>
