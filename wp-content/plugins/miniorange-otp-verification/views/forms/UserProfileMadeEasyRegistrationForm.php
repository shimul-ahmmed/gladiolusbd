...
echo'	<div class="mo_otp_form" id="'.get_mo_class($handler).'">
							<input type="checkbox" '.esc_attr($disabled).' id="upme_default" class="app_enable" data-toggle="upme_default_options" name="mo_customer_validation_upme_default_enable" value="1"
								 '.esc_attr($upme_enabled).' /><strong>'. esc_attr($form_name) .'</strong>';
...
echo'									</p>
										<div '.(esc_attr($upme_enable_type) != esc_attr($upme_type_phone) ? "hidden" : "").' id="upme_phone_instructions" class="mo_registration_help_desc">
											...
											<ol>
												<li><a href="'.esc_url($upme_field_list).'" target="_blank">'. mo_( "Click Here" ).'</a> '. mo_( " to see your list of fields" ).'</li>
												...
												<li>'. mo_( "Enter the Meta Key of the phone field" ).': <input class="mo_registration_table_textbox" id="mo_customer_validation_upme_phone_field_key" name="mo_customer_validation_upme_phone_field_key" type="text" value="'.esc_attr($upme_field_key).'"></li>
											</ol>
										</div>
...
echo'									<div '.(esc_attr($upme_enable_type) != esc_attr($upme_type_both) ? "hidden" :"").' id="upme_both_instructions" class="mo_registration_help_desc">
											...
											<ol>
												...
												<li>'. mo_( "Fill up the details of your new field and click on <b>Submit New Field</b>." ).'</li>
												<li>'. mo_( "Keep the <b>Meta Key</b> handy as you will need it later on." ).'</li>
												<li>'. mo_( "Enter the Meta Key of the phone field" ).': <input class="mo_registration_table_textbox" id="mo_customer_validation_upme_phone_field_key1" name="mo_customer_validation_upme_phone_field_key" type="text" value="'.esc_attr($upme_field_key).'"></li>
											</ol>
										</div>
									</p>
								</div>
