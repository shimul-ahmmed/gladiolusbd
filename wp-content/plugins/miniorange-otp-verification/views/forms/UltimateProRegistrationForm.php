...
echo'			<div class="mo_otp_form" id="'.get_mo_class($handler).'"><input type="checkbox" '.esc_attr($disabled).' id="ultimatepro" class="app_enable" data-toggle="ultipro_options" name="mo_customer_validation_ultipro_enable" value="1"
										'.esc_attr($ultipro_enabled).' /><strong>'. esc_attr($form_name) . '</strong>';
									...
									<p><input type="radio" '.esc_attr($disabled).' id="ultipro_email" class="app_enable" data-toggle="ultipro_email_instructions" name="mo_customer_validation_ultipro_type" value="'.esc_attr($umpro_type_email).'"
										...
										<div '.(esc_attr($ultipro_enabled_type) != esc_attr($umpro_type_email) ? "hidden" :"").' class="mo_registration_help_desc" id="ultipro_email_instructions" >
											...
											<ol>
												...
												<li><a href="'.esc_url($umpro_custom_field_list).'" target="_blank">'. mo_( "Click Here" ).'</a> '. mo_( "to see the list of your custom fields." ).'</li>
