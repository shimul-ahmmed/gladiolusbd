...
<table class="wf-form-table">
    ...
    Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
        ...
        array(
            ...
            'help_text'=>__('Select the additional order information in the invoice. If you want to show anyother custom fields, you can use <b> wf_pklist_alter_additional_fields </b> filter.To get this filter details, go to <b>general settings > Help guide > Filters </b> tab.','print-invoices-packing-slip-labels-for-woocommerce'),
        ),
        array(
            'type'=>"uploader",
