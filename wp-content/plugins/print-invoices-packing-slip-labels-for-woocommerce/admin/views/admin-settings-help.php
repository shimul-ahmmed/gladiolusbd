...
<div class="wf-tab-content" data-id="<?php echo $target_id;?>">
	...
	<div class="wf_sub_tab_container">		
		...
		<div class="wf_sub_tab_content" data-id="filters">
			...
			<input type="text" placeholder="search filter" id="filter_search_input" style="float: left;margin: 0 0 15px 0;width: 48%;border: 1px solid #ccc;">
			<table class="wp-list-table fixed striped wf_filters_doc" id="wf_filters_doc_table" style="width:100%;">
				<?php
				if(isset($wf_filters_help_doc) && is_array($wf_filters_help_doc))
				{
					foreach($wf_filters_help_doc as $key => $value) 
					{
						?>
						<tr>
							<td style="font-weight:bold;overflow-wrap:break-word;width:40%; "><?php echo $key;?></td>
